    ...
    <div className="atlas-flow">
      ...
      <section className="atlas-stage atlas-stage--settle">
        ...
        <svg className="atlas-scene atlas-scene--settle" viewBox="0 0 540 184" aria-hidden="true">
          ...
          <g className="atlas-thumbsup atlas-thumbsup--start"><g className="atlas-thumbsup-art atlas-thumbsup-art--start" transform="translate(21.175 24.325) scale(.65)"><path className="atlas-thumbsup-outline" d="M51 78V63c0-2 1-4 3-5l5-8c1-2 4-2 5 0 1 1 1 3 0 4l-2 7h11c3 0 5 2 5 5v10c0 7-5 11-12 11H57c-3 0-6-3-6-7z"/><path className="atlas-thumbsup-fingers" d="M66 67h7M66 72h7M66 77h6"/><path className="atlas-thumbsup-cuff" d="M43 75h8v14h-8z"/></g></g>
          <g className="atlas-thumbsup atlas-thumbsup--end"><g className="atlas-thumbsup-art atlas-thumbsup-art--end" transform="translate(167.475 24.325) scale(.65)"><path className="atlas-thumbsup-outline" d="M489 78V63c0-2-1-4-3-5l-5-8c-1-2-4-2-5 0-1 1-1 3 0 4l2 7h-11c-3 0-5 2-5 5v10c0 7 5 11 12 11h4c3 0 6-3 6-7z"/><path className="atlas-thumbsup-fingers" d="M474 67h-7M474 72h-7M474 77h-6"/><path className="atlas-thumbsup-cuff" d="M489 75h8v14h-8z"/></g></g>
