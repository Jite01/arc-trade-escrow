    ...
    <div className="atlas-flow">
      <section className="atlas-stage atlas-stage--define">
        ...
        <svg className="atlas-scene atlas-scene--define" viewBox="0 0 540 154" aria-hidden="true">
          ...
          <g className="atlas-handshake"><path d="m224 123 24-16 22 16-14 15c-4 4-10 4-14 0l-7-7-7 5-19-13z"/><path d="m316 123-24-16-22 16 14 15c4 4 10 4 14 0l7-7 7 5 19-13z"/></g>
      ...
      <section className="atlas-stage atlas-stage--settle">
        ...
        <svg className="atlas-scene atlas-scene--settle" viewBox="0 0 540 184" aria-hidden="true">
          <g className="atlas-port atlas-port--start"><path d="M27 128V94h16v34z"/><path d="M43 128v-18h22v18z"/><path d="M20 128h52"/><path d="M31 94V72h8v22z"/><circle cx="35" cy="67" r="4"/></g><g className="atlas-port atlas-port--end"><path d="M497 128V94h16v34z"/><path d="M475 128v-18h22v18z"/><path d="M468 128h52"/><path d="M501 94V72h8v22z"/><circle cx="505" cy="67" r="4"/></g>
          ...
          <g className="atlas-thumbsup atlas-thumbsup--end"><rect x="471" y="55" width="9" height="25" rx="4.5"/><rect x="471" y="76" width="23" height="10" rx="3"/></g>
